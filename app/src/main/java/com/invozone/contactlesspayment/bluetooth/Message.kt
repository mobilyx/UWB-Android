 ...
 */
sealed class Message(val status: String,val amount:Int?) {
    class RemoteMessage(status: String, amount: Int) : Message(status,amount)
    class LocalMessage(status: String, amount: Int) : Message(status,amount)
}