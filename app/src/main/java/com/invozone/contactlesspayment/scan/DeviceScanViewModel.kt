 ...
 */
package com.invozone.contactlesspayment.scan
...
import com.invozone.contactlesspayment.bluetooth.SERVICE_UUID
import com.invozone.contactlesspayment.scan.DeviceScanViewState.*
...
class DeviceScanViewModel(app: Application) : AndroidViewModel(app) {
    ...
    private val _deviceConnectionRequest=MutableLiveData<Boolean>()
    val deviceConnectionRequest=_deviceConnectionRequest as LiveData<Boolean>
    ...
    fun requestNewConnection(){
        _deviceConnectionRequest.value=true;
    }
    fun startScan() {
